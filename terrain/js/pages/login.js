  ...
  <div class="min-h-screen bg-brand-sand flex items-center justify-center px-4">
    <div class="w-full max-w-md">
      <div class="text-center mb-8">
        ...
        <span class="text-xs bg-teal-600 text-white px-2 py-1 rounded-full ml-1">Terrain</span>
        <p class="text-gray-500 mt-3 text-sm">Espace Intervenant</p>
      </div>
      <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
        <form id="login-form" class="space-y-5">
          ...
          <div>
            ...
            <input type="email" id="login-email" required autocomplete="email" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm" placeholder="prenom@daramanah.family">
          </div>
          <div>
          ...
          <button type="submit" id="login-btn" class="w-full bg-teal-600 text-white py-2.5 rounded-lg text-sm font-semibold hover:bg-teal-700 transition flex items-center justify-center gap-2">Se connecter</button>
        </form>
      </div>
    </div>
  </div>`;
